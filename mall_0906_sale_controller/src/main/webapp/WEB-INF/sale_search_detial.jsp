...
<body>
	...
	<div class="Dbox">
		<div class="box">
			<div class="left">
				<div class="timg">
					<img src="upload/image/${obj_sku.spu.shp_tp }" alt="">
				</div>
				<div class="timg2">
					<div class="lf">
						<img src="js/images/lf.jpg" alt="">
					</div>
					<div class="center">
						<c:forEach items="${obj_sku.list_image }" var="image">
							<span><img src="upload/image/${image.url }" alt=""></span>
						</c:forEach>
					</div>
					<div class="rg">
						<img src="js/images/rg.jpg" alt="">
					</div>
				</div>
				<div class="goods">
					<img src="js/images/img_6.jpg" alt="">
				</div>
			</div>
			<div class="cent">
				...
				<div class="clear">
					...
					<c:forEach items="${list_sku}" var="sku">
						<div class="min_mx">
							<a
								href="goto_sku_detail.do?sku_id=${sku.id}&spu_id=${sku.shp_id}">${sku.sku_mch}</a>
						</div>
					</c:forEach>
				</div>
				<div class="clear">
				...
				<div class="clear" style="margin-top: 20px;">
					...
					<div class="num_box">
						...
						<div class="rg">
							<img src="js/images/jia.jpg" id='jia' alt=""> <img
								src="js/images/jian.jpg" id='jian' alt="">
						</div>
					</div>
				</div>
				<div class="clear" style="margin-top: 20px;">
					<form id="cart_form" action="add_cart.do" method="post">
						...
						<img src="js/images/mai.jpg" alt=""> 
						<img src="js/images/shop.jpg" onclick="cart_submit()" alt=""
