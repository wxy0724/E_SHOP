...
public class LoginController {
	...
	public String login(String dataSource_type,T_MALL_USER_ACCOUNT loginUser,@CookieValue(value="list_cart_cookie",required=false)String list_cart_cookie,
	...
	private void merge_cart(List<T_MALL_SHOPPINGCAR> list_shopping_cart_by_yhid,String list_cart_cookie,T_MALL_USER_ACCOUNT user,
