...
<body>
	...
	<jsp:include page="../manage_class_attr.jsp"></jsp:include>
		...
		<br><br>
		<table>
			<tr><td>属性名:<input type="text" name="list_attr[1].shxm_mch"/></td><td>添加值</td></tr>
			<tr><td>属性值:<input type="text" name="list_attr[1].list_value[0].shxzh"/></td><td>单位:<input type="text" name="list_attr[1].list_value[0]shxzh.shxzh_mch"/></td><td>删除</td></tr>
			<tr><td>属性值:<input type="text" name="list_attr[1].list_value[1].shxzh"/></td><td>单位:<input type="text" name="list_attr[1].list_value[1]shxzh.shxzh_mch"/></td><td>删除</td></tr>
		</table>
